...
namespace QuanLySinhVien
{
    internal class Student
    {
        ...
        public byte[] Picture { get; set; } // Mảng byte chứa file ảnh
        ...
        public bool AddStudent()
        {
            try
            {
                ...
                string query = "INSERT INTO Student (MSSV, Fname, Lname, Dob, Gder, Phone, Address, Htown, Email, Picture) VALUES " +
